...
Free, private PDF toolkit at [croppdf.netlify.app](https://croppdf.netlify.app). Built with React and Vite. PDFs are processed entirely in the browser — nothing is uploaded to a server.
...
- Canonical domain: `https://croppdf.netlify.app`
...
After deploy, submit the sitemap in [Google Search Console](https://search.google.com/search-console) for `croppdf.netlify.app`.
